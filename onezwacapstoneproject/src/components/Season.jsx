...
const Season = (props) => {
  ...
  return (
    <div>
      <dialog className="season-dialog" open={state.season ? true : false}>
        ...
        <div className="seasons">
          {showPrevBtn && (
            <div className="prev-season" onClick={previousSeasonHandler}>
          ...
          {showNextBtn && (
            <div className="next-season" onClick={nextSeasonHandler}>
